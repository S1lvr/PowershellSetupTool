...
function Get-Custom
{
	...
	$AteraKey = New-Object System.Windows.Forms.TextBox
		...
		$AteraKey.Size = New-Object System.Drawing.Size(260, 20)
	...
	$WebrootKey = New-Object System.Windows.Forms.TextBox
		...
		$WebrootKey.Size = New-Object System.Drawing.Size(260, 20)
		$formcustom.Controls.Add($WebrootKey)

	$label3 = New-Object system.windows.forms.Label
		$label3.location = New-Object system.drawing.point (120, 20)
	...
	$newclientname = New-Object system.windows.forms.TextBox
		$newclientname.location = New-Object System.Drawing.Point(120, 40)
	...
	$checkbox4 = New-Object System.Windows.Forms.checkbox
		$checkbox4.location = New-Object system.drawing.point(10, 240)
	...
	if (($result -eq [System.Windows.Forms.DialogResult]::OK))
	{
		...
		if (Test-Path -Path $clienttest) #this IF check if the custom client already exists.
		{
		...
		} else { #if it doesn't let's go
			$firstline = -join ("function Get-", $newclientname)
			...
			Install-Atera -ClientID $AteraKey
			$newclientarray += -join ("Install-Atera -ClientID ", $AteraKey)
			Install-Webroot -key $WebrootKey
			$newclientarray += -join ("Install-Webroot -key ", $WebrootKey)
			...
			if ($savenewclient -eq $true)
			{
				...
				{
					$outfilename = -join (".\CustomClients\", $newclientname, ".ps1")
					$newclientarray | Out-File $outfilename
				}
				else
				{
...
$okbutton.Add_Click({
		If (Test-Connection -TargetName google.com -quiet) 
		{
			Write-Host "Connection works, continuing setup"
		} else {
			$msgBoxInput =  [System.Windows.MessageBox]::Show('Internet Connection or DNS Connection Fault, Continue?','Game  input','YesNo','Error')
			switch  ($msgBoxInput) {
  				'Yes' {
  					break
  				}
